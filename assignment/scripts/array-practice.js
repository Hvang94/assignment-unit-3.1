...
let favoriteFoods=['Pho', 'Pad Thai', 'Steak', 'Ribs', 'Sushi'];
...
console.log('My favorite desset is;', favoriteFoods);
...
console.log(gems);
let gemChange = 1; // changing citrine
let newGem = 'Tourmaline';
gems[gemChange] = newGem;
console.log(gems);
